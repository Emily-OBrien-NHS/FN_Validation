...
obs_splits = [(np.nan, 'Triaged (Ambulatory)', 100, 'Obs 60 min (Ambulatory)'),
              ('Triaged (Majors)', 'Triaged - Kickoff 60 min Obs (Majors)', 85, 'Obs 60 min (Majors)'),
              ('Triaged (Majors)', 'Triaged - Kickoff 30 min Obs (Majors)', 15, 'Obs 30 min (Majors)'),
              ('Triaged (Resus)', 'Triaged - Kickoff 60 min Obs (Resus)', 60, 'Obs 60 min (Resus)'),
              ('Triaged (Resus)', 'Triaged - Kickoff 30 min Obs (Resus)', 40, 'Obs 30 min (Resus)')]
